...
const headers = ["题干", "题型", "难度", "选项A", "选项B", "选项C", "选项D", "正确答案", "知识点ID"];
...
XLSX.utils.book_append_sheet(wb, ws, "航天知识题库");

XLSX.writeFile(wb, "d:\\1\\space-knowledge-platform\\航天知识题库导入模板.xlsx");

console.log("Excel文件生成成功！");
console.log("文件路径：d:\\1\\space-knowledge-platform\\航天知识题库导入模板.xlsx");
